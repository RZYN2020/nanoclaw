...
export const TELEGRAM_PROXY_URL =
  process.env.TELEGRAM_PROXY_URL || envConfig.TELEGRAM_PROXY_URL || '';

// Anthropic/DashScope API configuration
...
export const ANTHROPIC_MODEL =
  process.env.ANTHROPIC_MODEL || envConfig.ANTHROPIC_MODEL || 'claude-3-sonnet-20240229';
